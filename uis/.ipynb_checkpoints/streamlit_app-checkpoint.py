...
##################################
X_train_smote = pd.read_csv(os.path.abspath(os.path.join(os.getcwd(),"..", DATASETS_FINAL_TRAIN_FEATURES_PATH, "X_train_smote.csv")))
y_train_smote = pd.read_csv(os.path.abspath(os.path.join(os.getcwd(),"..", DATASETS_FINAL_TRAIN_TARGET_PATH, "y_train_smote.csv")))
